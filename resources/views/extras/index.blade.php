...
@section('content')
<div class="row">
<a href="{{ route('extras.create') }}" style="text-decoration: none; color: white;"><button type="button" class="btn btn-primary">Añadir ingrediente extra</button></a>
        ...
        <tbody>
                @foreach ($extras as $extra)
                    <tr>
                        ...
                        <td><input type="number" id="extra-{{ $extra->id }}" name="{{ $extra->id }}"
